...
class DataGenerator(Sequence):
    ...
    def _prepare_indices(self):
        ...
        batches = indices.reshape((self._num_batches, self._batch_size, self._concat_length))
    ...
    def _label_sample(self, idx):
        ...
        bound = np.zeros((length, 2*self._data.num_classes), dtype=self._calculation_dtype)
    ...
    def _pad_batch(self, seq):
        ...
        return pad_sequences(seq, maxlen=None, dtype=self._calculation_dtype, padding="post", value=-1.0)
    ...
    def on_epoch_end(self):
        ...
        self._permute = np.int32(1 - (2 * np.random.randint(0, possible_permutations+1, (self._num_sequences, 2))))