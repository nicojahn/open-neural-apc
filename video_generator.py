...
def create_video(epoch, video_index, sequence, prediction, upper_bound, lower_bound, input_dimensions, \
                class_names, dpi=300, fps=10):
...
def create_videos(x, y, predictions, epoch, video_idx_offset, class_names):
    ...
    for sample_idx, prediction in enumerate(tqdm(predictions, desc="Videos created", leave=False, unit="videos")):
        ...
        create_video(epoch, video_index, input_sequence, pred, lower_bound, upper_bound,
